        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <div>
              ...
              <p className="text-[18px] font-normal leading-[138%] text-[var(--text-color3)] mb-[25px]">
          ...
          <div className="relative">
            <img
              ...
              alt="About"
              className="relative w-[90%] h-[580px] object-cover rounded-[15px] ml-auto"
            />

            <div className="absolute bottom-[20px] left-0 max-w-[232px] h-[136px] bg-[var(--primary-color)] rounded-[10px] px-[12px] py-[21px] text-center">
              <h3 className="text-[33.21px] font-semibold text-[var(--secondary-color)] mb-[8px]">
                15+ Years
              </h3>

              <p className="text-[16px] font-normal leading-[138%] text-[var(--secondary-color)] mb-0">
                Leading aesthetic dentistry education worldwide
              </p>
            </div>
          </div>
