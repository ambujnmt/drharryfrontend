    ...
    <div className="flex items-center justify-center min-h-screen p-4 bg-[#5274F6]">
      ...
      <div className="lg:mt-20 md:mt-20 mt-20 xl:mt-0 flex justify-center md:flex-row  rounded-lg  w-full  overflow-hidden">
        ...
        <div className="w-full md:w-1/2  flex flex-col justify-center">
          <h2 className="font-bold text-md md:text-2xl lg:text-3xl xl:text-4xl mb-8 text-center text-white">{translateText("welcome")}</h2>
          ...
          <div className="font-bold text-[11px] md:text-[14px] lg:text-[16px] xl:text-[16px] my-2 text-center rounded-[600px] bg-[#FFBA1B] py-2"><Link href="/emailSignUp" className="text-white uppercase">{translateText("email")}</Link></div>
          <div className="font-bold text-[11px] md:text-[14px] lg:text-[16px] xl:text-[16px] my-2 text-center text-white rounded-[600px] bg-[rgb(0,79,229)] py-2 uppercase">{translateText("facebook")}</div>
          <div className="font-bold uppercase text-[11px] md:text-[14px] lg:text-[16px] xl:text-[16px] my-2 text-center text-white ">{translateText("or")}</div>
          <div className="font-bold text-[11px] md:text-[14px] lg:text-[16px] xl:text-[16px] my-2 text-center text-white rounded-[600px] bg-[#FFBA1B] py-2"><Link href="/login" className="text-white uppercase">{translateText("login")}</Link></div>
        </div>
      </div>
    </div>
  );
