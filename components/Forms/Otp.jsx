      ...
      <div className="lg:mt-20 md:mt-20 mt-20 xl:-mt-32 flex justify-center md:flex-row rounded-lg w-full overflow-hidden">
        <div className="w-full md:w-1/2 flex flex-col justify-start">
          <div className="flex justify-center items-center gap-4 mb-6">
            ...
            <span className="rounded-[25px] bg-[#FFBA1B] py-1 w-28 font-normal text-[11px] md:text-[14px] lg:text-[16px] xl:text-[18px] uppercase text-center text-white">{translateText("login")}</span>
          </div>
          <p className="font-bold text-md md:text-2xl lg:text-3xl xl:text-4xl text-center text-white my-20">{translateText("enter_email")}</p>
          <div>
            <Input
          ...
          <button
            ...
            className="font-bold uppercase text-[11px] md:text-[14px] lg:text-[16px] xl:text-[16px] my-2 text-center rounded-[600px] bg-[#FFBA1B] py-2"
          >
